...
function partSwap.patch(core)
    ...
    function UNInf.modelpartInflation:new(parts,infAnim, minInf, maxInf, conditionals)
        ...
        assert(type(self.minInf) == "number", "Your minimum inflation for your modelspartInflation modules is not a valid number!")
        assert(type(self.maxInf) == "number", "Your maximum inflation for your modelspartInflation modules is not a valid number!")
